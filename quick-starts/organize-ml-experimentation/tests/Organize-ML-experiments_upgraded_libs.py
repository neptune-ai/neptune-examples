...
get_ipython().system(' pip install --user scikit-learn==0.23.1 joblib==0.15.1 neptune-client==0.4.123')

get_ipython().system(' pip install --user --upgrade scikit-learn joblib neptune-client')
