...
get_ipython().system(' pip install --quiet tensorboard==2.4.0 tensorflow==2.3.1 neptune-tensorboard==0.5.1 neptune-client==0.4.129')
...
get_ipython().system(' pip install --quiet neptune-contrib matplotlib scikit-plot --upgrade')
